        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              axios__WEBPACK_IMPORTED_MODULE_12___default.a.post("https://www.google.com/recaptcha/api/siteverify?secret=".concat(RECAPTCHA_SECRET, "&response=").concat(value['g-recaptcha-response'])).then(function (res) {
                console.log(res);
              }, function (err) {
                console.log(err);
              });
...
//# sourceMappingURL=index.js.bfadd5ecd1d0ecf60aaa.hot-update.js.map